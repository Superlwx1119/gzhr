<template>
  <!-- 体检项目匹配审核-->
  <div class="projectMatchAudit">
    <el-row :gutter="10" class="tab-body">
      <el-col :md="10" :lg="8" :xl="6" class="tab-body-left">
        <left-search-table :search-height="'100px'" :show-more-btn="false" :on-search="search">
          ...
          <div slot="list" class="box">
            ...
            <div class="box-body">
              <MyTableView :border="true" :first-highlight="true" :highlight-current-row="true" :columns="columns" :data="tableData" @rowClick="rowClick" />
            ...
            <section class="layer" style="height: calc(100% - 172px)">
              <div class="box">
                <div class="box-header handle">
                  <span class="box-title">匹配项目审核</span>
                  <div class="box-tools">
