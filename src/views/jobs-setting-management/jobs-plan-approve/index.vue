  ...
  <div class="specialPersonBonusVerification">
    <normal-layer :search-number="7">
      ...
      <div slot="table-title" class="box-header handle">
        <span class="box-title">岗位设置方案审批列表</span>
...
export default {
  ...
  methods: {
    ...
    search() {
      const form = Object.assign(this.queryForm, { pageNum: this.pageInfo.pageNum, pageSize: this.pageInfo.pageSize, workflowNode: 3 })
