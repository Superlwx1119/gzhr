  ...
  <div class="specialPersonBonusVerification">
    <normal-layer :search-number="7">
      ...
      <div slot="table-title" class="box-header handle">
        <span class="box-title">特岗设置申报列表</span>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: '流程状态', prop: 'c' },
        { label: '主体岗位', prop: 'aab019' },
        { label: '申报岗位名称', prop: 'rb0195' },
        { label: '申报岗位等级', prop: 'aab022' },
        { label: '申报数量', prop: 'aab023' },
        { label: '单位岗位总量', prop: 'rb0705' },
        { label: '起始日期', prop: 'i' },
        { label: '结束日期', prop: 'i' },
        { label: '结办时间', prop: 'i' },
        { label: '方案状态', prop: 'i' },
