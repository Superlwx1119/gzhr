  ...
  <Drawer :title="drawerTitle" :size="size" :show="isDrawerVisible" @update:isShow="isShow" @resetForm="resetForm">
    <div class="drawer-content">
      <div class="box" style="height: auto">
        <box-title title-name="赴外就医审核扣款汇总" />
        <div class="box-body">
          <table-items
      ...
      <div class="table-wrapper box">
        <div class="layer-tab">
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane label="赴外就医审核扣款明细" name="first">
              <div class="box">
                <div class="box-body">
            ...
            <el-tab-pane label="清分比对信息" name="second">
              <div class="box">
                <div class="box-header handle">
                  <div class="box-tools">
                    <el-button type="primary">清分对比</el-button>
                    <el-button type="primary">清分确认</el-button>
                    <el-button type="primary">取消清分确认</el-button>
                  </div>
                </div>
                <div class="box-body">
                  <MyTableView :border="true" :columns="contrastColumns" :data="contrastData" />
                  <Pagination />
                </div>
              </div>
            </el-tab-pane>
...
<script>
import { deductionColumns, contrastColumns } from './../tableColumns'
...
export default {
  ...
  data() {
    return {
      ...
      deductionData: [
        {
          '结算审核扣款信息ID': '8372883213',
          '费用明细审核扣款信息ID': '2121212',
          '费用明细流水号': '23432432',
          '医疗机构三大目录编码': '321412423',
          '医疗机构三大目录名称': '药不能停',
          '本条费用明细扣款金额(元)': '324.32',
          '医疗费用扣款原因': 'sd',
          '备注': '药不能停',
