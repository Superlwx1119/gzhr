            ...
            <div slot="list" class="box">
              <div class="box-header handle">
                ...
                <div class="box-tools">
                  ...
                  <el-button type="primary" @click="reSummary">二次汇总</el-button>
                  <el-button type="primary" @click="cancelSummary">取消二次汇总</el-button>
                </div>
              </div>
              <div class="box-body">
...
export default {
  ...
  methods: {
    ...
    // },
    reSummary() {
      this.$msgSuccess('二次汇总成功')
    },
    cancelSummary() {
      this.$msgSuccess('取消二次汇总成功')
    }
    // audit() {
    //   this.showAuditDialog = true
    //   this.dialogTitle = '医疗费结算表审签'
