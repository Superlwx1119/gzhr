<template>
  <div class="detail">
    <form-dialog title="医保关系转入详细" width="1200px" new-calss="big" :is-show="show" @update:isShow="addIsShow">
      <div class="box">
        <div class="box-body">
          <el-form ref="addForm" :model="addForm" :rules="rules" label-width="105px">
            ...
            <table class="table-data total-info">
              <tbody>
                ...
                <tr>
                  ...
                  <td>个人参保状态</td>
                  <td colspan="5">{{ addForm.个人参保状态 }}</td>
                </tr>
              </tbody>
            </table>
            <div class="box-header handle">
            ...
            <table class="table-data total-info">
              <tbody>
                <tr>
                  ...
                  <td>{{ addForm.申请人电话 }}</td>
                  <td>原经办机构行政区划代码</td>
                  <td>{{ addForm.原经办机构行政区划代码 }}</td>
                  <td>原经办机构名称</td>
                  <td>{{ addForm.原经办机构名称 }}</td>
                  <td>原经办机构联系人</td>
                  <td>{{ addForm.原经办机构联系人 }}</td>
                </tr>
                <tr>
                  <td>原经办机构电话</td>
                  <td>{{ addForm.原经办机构电话 }}</td>
                  <td>省</td>
                  <td>{{ addForm.省 }}</td>
                  <td>市</td>
                  <td>{{ addForm.市 }}</td>
            ...
            <table class="table-data total-info">
              <tbody>
                ...
                <tr>
                  <td>匹配个账姓名</td>
                  <td>{{ addForm.匹配个账姓名 }}</td>
                  <td>匹配个账转出地</td>
                  <td>{{ addForm.匹配个账转出地 }}</td>
                  <td>匹配方式</td>
                  <td colspan="3">{{ addForm.匹配方式 }}</td>
                </tr>
              </tbody>
            </table>
            <div class="box-header handle">
