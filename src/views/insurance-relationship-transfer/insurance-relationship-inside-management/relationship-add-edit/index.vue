  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: '证件类型', label: '证件类型', align: 'center', overflow: true },
        { prop: '异地机构代码', label: '异地机构代码', align: 'center', overflow: true },
        { prop: '转出地', label: '转出地', align: 'center', overflow: true },
        { prop: '办理形式', label: '办理形式', align: 'center', overflow: true },
        { prop: '录入人', label: '录入人', align: 'center', overflow: true },
        { prop: '录入时间', label: '录入时间', align: 'center', overflow: true },
        { prop: '个账匹配方式', label: '个账匹配方式', align: 'center', overflow: true },
        { prop: '个账确认情况', label: '个账确认情况', align: 'center', overflow: true },
        { prop: '业务状态', label: '业务状态', align: 'center', overflow: true },
        { prop: '申请源', label: '申请源', align: 'center', overflow: true },
        { prop: '打印凭证时间', label: '打印凭证时间', align: 'center', overflow: true },
        { prop: '打印人', label: '打印人', align: 'center', overflow: true },
