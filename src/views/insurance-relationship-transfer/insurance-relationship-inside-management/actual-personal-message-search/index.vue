        ...
        <div class="box-body query">
          <el-form ref="searchForm" :model="searchForm" label-width="105px">
            <el-row :gutter="10">
              ...
              <el-col :md="12" :lg="8" :xl="6">
                <el-form-item label="申请来源" prop="申请来源">
                  <ApplySource v-model="searchForm.申请来源" />
                </el-form-item>
              </el-col>
        ...
        <div class="box-body">
          <div class="box">
            <div class="box-header handle">
              <span class="box-title">医保关系转入个账查询与确认列表</span>
              <div class="box-tools">
...
import ApplySource from '@/components/Select/ApplySource'
export default {
