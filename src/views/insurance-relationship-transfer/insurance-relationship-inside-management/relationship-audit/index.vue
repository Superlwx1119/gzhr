<template>
  ...
  <div class="addEdit item4">
        ...
        <div class="box-body">
          <div class="box">
            <div class="box-header handle">
              <span class="box-title">医保关系转入审核列表</span>
              <div class="box-tools">
                <el-button type="primary" @click="isShowAudit = true">批量审核</el-button>
                <el-button type="primary">取消审核</el-button>
                <el-button type="primary" @click="isShowPrint = true">打印《转入情况确认表》</el-button>
              </div>
            </div>
    ...
    <!-- 审核 -->
    <AuditDialog v-model="isShowAudit" dialog-title="医保关系转入审核" />
  </div>
</template>
