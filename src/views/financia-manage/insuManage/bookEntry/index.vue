...
<template>
  ...
  >
    ...
    <template slot="title-btns">
      ...
      <el-button type="primary" @click="detailsClick">新增导盘</el-button>
    </template>
    ...
    >
      <template slot="operation" slot-scope="scope">
        <el-button type="text" class="modify" @click="editClick(scope.row)">编辑</el-button>
