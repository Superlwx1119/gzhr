  ...
  >
    ...
    >
      <template slot="operation" slot-scope="scope">
        <el-button type="text" class="modify" @click="addClick(scope.row, 'edit')">修改</el-button>
...
export default {
  ...
  methods: {
    addClick(row, el) {
      if (el === 'edit') {
        this.dialogTitle = '修改业务类型'
      } else {
        this.dialogTitle = '增加业务类型'
      }
      this.showEditDialog = true
    },
    detailsClick(row) {
      this.dialogTitle = '业务类型'
