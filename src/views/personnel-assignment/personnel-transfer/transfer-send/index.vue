  ...
  <div class="TransferSend">
    <normal-layer :search-number="5">
      ...
      <div slot="table-title" class="box-header handle">
        <span class="box-title">人员划转发文列表</span>
        <div slot="title-btns" class="box-tools">
          <el-button type="primary">下载登记表</el-button>
          <el-button type="primary">行文</el-button>
        </div>
      </div>
      <template>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: '划出单位名称', prop: 'c' },
        { label: '划入单位名称', prop: 'aab019' },
        { label: '划入单位性质', prop: 'rb0195' },
