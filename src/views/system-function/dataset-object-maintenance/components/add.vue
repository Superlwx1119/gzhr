<template>
  <form-dialog :is-show="visible" title="新增数据集对象" @update:isShow="updateIsShow" @resetForm="resetForm">
      ...
      <el-row :gutter="12">
        ...
        <el-col :span="12">
          <el-form-item label="数据元编码" prop="dataCode">
            <el-input v-model="addForm.dataCode" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="数据元中文名" prop="dataName">
            <el-input v-model="addForm.dataName" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="数据元类型" prop="dataType">
            <el-select v-model="addForm.dataType" style="width: 100%" placeholder="请选择">
              <el-option label="aaa" value="1" />
              <el-option label="bbb" value="2" />
            </el-select>
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="数据元精度" prop="dataPrecision">
            <el-input v-model="addForm.dataPrecision" placeholder="请输入" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
