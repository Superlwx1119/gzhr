...
<template>
  ...
  >
    ...
    <div class="box" style="height: auto">
      <box-title title-name="支取信息" title-need-handle>
...
export default {
  ...
  data() {
    return {
      ...
      formItemsDatas: [
        { label: '支取原因', prop: 'xxx', type: 'select' },
        { label: '送单人', prop: 'xxxx', type: 'input' },
        { label: '联系电话', prop: 'xxxx', type: 'input' },
        { label: '个人账户处理', prop: 'xxx', type: 'select' },
        { label: '支取人姓名', prop: 'xxxx', type: 'select' },
        { label: '支取人证件类', prop: 'xxxx', type: 'select' },
        { label: '支取人证件号', prop: 'xxxx', type: 'select' },
        { label: '支取日期', prop: 'date', type: 'date' }
      ],
      formDataForm: {
        xxxx: '',
        xxx: '',
      ...
      itemsDatas1: [
        [
          { label: '账户处理方式', prop: 'xxx' },
          { label: '个人账户余额', prop: 'xxx' },
          { label: '开户银行', prop: 'xxx' }
        ],
        [
          { label: '卡状态', prop: 'xxx' },
