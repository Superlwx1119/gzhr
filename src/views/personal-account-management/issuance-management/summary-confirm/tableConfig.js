...
export const detailColumns = [
  ...
  { label: '对应费款所属期', prop: '对应费款所属期' },
  { label: '参保身份', prop: '参保身份' },
  { label: '个人划入个账金额(元)', prop: '个人划入个账金额(元)' },
  { label: '单位划入个账金额(元)', prop: '单位划入个账金额(元)' },
  { label: '门诊统筹基金扣减金额(元)', prop: '门诊统筹基金扣减金额(元)' },
  { label: '实际划款(元)', prop: '实际划款(元)' },
  { label: '注资基数', prop: '注资基数' },
  { label: '医保区划', prop: '医保区划' }
]
