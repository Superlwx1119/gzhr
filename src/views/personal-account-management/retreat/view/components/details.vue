          ...
          <section class="layer layer-query">
            <div class="box">
              ...
              <div class="box-body query">
                ...
                />
                <form-items :items-datas="itemsDatas2" :form-datas="seachForm" :is-grid="false" :span="8">
...
export default {
  name: '',
  components: { FormItems, TableItems },
  mixins: [],
  props: {
    show: {
      type: Boolean,
  ...
  data() {
    return {
      ...
      itemsDatas2: [
        ...
        { label: '人员变更类型', prop: 'xxx', type: 'select' }
      ]
