<template>
  ...
  >
    ...
    <template slot="title-btns">
      <el-button type="primary" @click="addClick">新增补注申请</el-button>
    </template>
    ...
    >
      <template slot="operation" slot-scope="scope">
        <el-button type="text" class="modify" @click="detailsClick(scope.row)">修改</el-button>
        <el-button type="text" class="modify" @click="deleteEvent(scope.row)">删除</el-button>
        <el-button type="text" class="modify">扫码</el-button>
      </template>
    </my-table-view>
    <Pagination />
...
export default {
  ...
  methods: {
    addClick(row) {
      this.dialogTitle = '个人扣减新增申请'
      this.showAuditDialog = true
    },
    detailsClick(row) {
      this.dialogTitle = '个人账户补注扣减信息修改'
