  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: 'name', label: '余额（元）', align: 'center' },
        { prop: 'name', label: '证件号码', align: 'center' },
        { prop: 'name', label: '姓名', align: 'center' },
        { prop: 'name', label: '出生日期', align: 'center' },
        { prop: 'name', label: '医疗人员类别', align: 'center' },
        { prop: 'name', label: '单位名称', align: 'center' },
        { prop: 'name', label: '所属行业', align: 'center' },
        { prop: 'name', label: '特殊单位类别', align: 'center' },
        { prop: 'name', label: '隶属关系', align: 'center' },
        { prop: 'name', label: '经济类型', align: 'center' },
        { prop: 'name', label: '单位类型', align: 'center' },
        { prop: 'name', label: '年度', align: 'center' },
        { prop: 'name', label: '发放方式', align: 'center' },
        { prop: 'name', label: '拨付对象类型', align: 'center' },
        { prop: 'name', label: '返换类型', align: 'center' },
        { prop: 'name', label: '计息标志' },
        { prop: 'name', label: '支付标志', align: 'center' },
        { prop: 'name', label: '账户返还金额（元）', align: 'center', width: '150px' },
        { prop: 'name', label: '金融行业机构代码', align: 'center', width: '150px' },
        { prop: 'name', label: '银行行别代码', align: 'center' },
        { prop: 'name', label: '银行账号', align: 'center' },
        { prop: 'name', label: '户名', align: 'center' },
        { prop: 'name', label: '银行同城异地标志', align: 'center', width: '150px' },
        { prop: 'name', label: '申请人' },
        { prop: 'name', label: '申请时间', align: 'center' },
        { prop: 'name', label: '审核标志', align: 'center' },
        { prop: 'name', label: '审核人', align: 'center' },
        { prop: 'name', label: '审核时间', align: 'center' },
        { prop: 'name', label: '审核意见', align: 'center' }
