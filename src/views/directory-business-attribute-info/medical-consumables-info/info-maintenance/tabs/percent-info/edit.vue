<template>
  <form-dialog title="自付比例修改" width="1100px" new-calss="big" :is-show="show" @update:isShow="addIsShow">
    <div class="box layer-tab">
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane label="正常自付比例" name="first">
          <el-form ref="addForm" :model="editNormalForm" label-width="105px">
            <div class="box">
              <div class="box-body">
                <el-row :gutter="10">
                  <el-col :span="8">
                    <el-form-item label="医保目录" prop="医保目录">
                      <insurance-directory v-model="editNormalForm.医保目录" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="医疗收费项目" prop="医疗收费项目">
                      <medical-charge-category v-model="editNormalForm.医疗收费项目" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
                ...
                <el-row :gutter="10">
                  <el-col :span="8">
                    <el-form-item label="医保区划" prop="医保区划">
                      <insurance-area-division v-model="editNormalForm.医保区划" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="自付比例人员" prop="自付比例人员">
                      <self-pay-proportion-people v-model="editNormalForm.自付比例人员" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="自付比例类别" prop="自付比例类别">
                      <self-pay-proportion-type v-model="editNormalForm.自付比例类别" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="自付比例" prop="自付比例">
                      <el-input v-model="editNormalForm.自付比例" placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="段内自付比例" prop="段内自付比例">
                      <el-input v-model="editNormalForm.段内自付比例" placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="起始日期" prop="起始日期">
                      <el-date-picker v-model="editNormalForm.起始日期" type="daterange" style="width: 100%;" start-placeholder="选择日期" end-placeholder="选择日期" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
        ...
        <el-tab-pane label="浮动自付比例" name="second">
          <el-form ref="addForm" :model="editFloatForm" label-width="105px">
            <div class="box">
              <div class="box-body">
                <el-row :gutter="10">
                  <el-col :span="8">
                    <el-form-item label="医保目录" prop="医保目录">
                      <insurance-directory v-model="editFloatForm.医保目录" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="医疗收费项目" prop="医疗收费项目">
                      <medical-charge-category v-model="editFloatForm.医疗收费项目" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <el-row :gutter="10">
                  <el-col :span="8">
                    <el-form-item label="医保区划" prop="医保区划">
                      <insurance-area-division v-model="editFloatForm.医保区划" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="自付比例人员" prop="自付比例人员">
                      <self-pay-proportion-people v-model="editFloatForm.自付比例人员" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="自付比例类别" prop="自付比例类别">
                      <self-pay-proportion-type v-model="editFloatForm.自付比例类别" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="比例维护方式" prop="比例维护方式">
                      <el-input v-model="editFloatForm.比例维护方式" disabled placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="起始日期" prop="起始日期">
                      <el-date-picker v-model="editFloatForm.起始日期" type="daterange" style="width: 100%;" start-placeholder="选择日期" end-placeholder="选择日期" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="浮动比例" prop="浮动比例">
                      <el-input v-model="editFloatForm.浮动比例" placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="金额上限" prop="金额上限">
                      <el-input v-model="editFloatForm.金额上限" placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="金额下限" prop="金额下限">
                      <el-input v-model="editFloatForm.金额下限" placeholder="请输入" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
