          ...
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="自付比例人员" prop="自付比例人员">
                <self-pay-proportion-people v-model="addForm.自付比例人员" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="自付比例类别" prop="自付比例类别">
                <self-pay-proportion-type v-model="addForm.自付比例类别" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="自付比例" prop="自付比例">
                <el-input v-model="addForm.自付比例" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="段内自付比例" prop="段内自付比例">
                <el-input v-model="addForm.段内自付比例" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
