    ...
    <section class="layer layer-result">
      <div class="box">
        <div class="box-header handle">
          <span class="box-title">系统参数维护</span>
          <div class="box-tools">
  ...
  data() {
    return {
      ...
      tableColumns: [
        ...
        { label: '开始日期', prop: '开始日期', align: 'center', overflow: true },
        { label: '结束日期', prop: '结束日期', align: 'center', overflow: true },
      ...
      tableOperates: {
        ...
        list: [
          { show: true, type: 'text', label: '修改', method: (key, row, index) => {
            ...
            this.dialogtitle = '系统参数修改'
          } },
          { show: true, type: 'text', label: '删除', class: 'delete', method: (key, row, index) => { this.$msgConfirm('确认删除') } }
        ]
      },
      tableData: [1, 2, 3, 4, 5, 6, 7].map(item => {
        return { '参数名称': '参数名称', '参数代码': '参数代码', '医疗类别': '医疗类别',
          ...
          '备注': '备注', '最后操作人': '最后操作人', '最后操作时间': '最后操作时间' }
      })
    }
  },
  computed: {},
