    ...
    <section class="layer-tab">
      ...
      >
        <template slot="left-tools">
          <div class="box-tools">
            <el-button type="primary" @click="isShowSingle = true">零星补缴</el-button>
            <el-button type="primary" @click="isShowBatch = true">批量补缴</el-button>
          </div>
        </template>
        <template slot="right-tools">
          <el-button type="primary" @click="isShowSingle = true">申请信息</el-button>
          <el-button type="danger" @click="deleteDetail">删除</el-button>
        </template>
      </Allocated>
    </section>
    <!-- 零星补缴 -->
    <SingleApplyMessage :show.sync="isShowSingle" />
    <!-- 批量补缴 -->
...
export default {
  ...
  data() {
    return {
      searchArr: ['单位名称', '单位编码', '复核状态', '姓名', '证件号码'],
      activeName: 'first',
      selection: [],
      queryForm: {},
      isShowSingle: false,
