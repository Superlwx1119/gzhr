...
<template>
  <div class="third-index supplementaryReceipt">
    ...
    <!-- 审核 -->
    <AuditDialog v-model="isShowAudit" dialog-title="单位补收审核" />
  </div>
</template>
...
export default {
  name: 'SupplementaryReceiptReview',
  components: {
    Allocated,
    AuditDialog
    // Business
