<template>
  <div class="listAuditAdd">
    <form-dialog title="铺底资金审核明细" width="1000px" new-class="big" :is-show="show" @update:isShow="addIsShow">
      <div class="box">
        <div class="box-body">
          <el-form ref="searchForm" :model="searchForm">
            <div class="box-header handle">
              <span class="box-title">铺底资金审核明细</span>
            </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: '人员类型', label: '人员类型', align: 'center', overflow: true },
