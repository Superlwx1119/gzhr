<template>
  <el-row :gutter="10" class="tab-body">
        ...
        <left-search-table :search-height="'150px'" :show-more-btn="true">
          ...
          <div slot="list" class="box">
            <div class="box-header handle">
              <span class="box-title">单位医疗保险费已核销列表</span>
    ...
    <el-col :md="14" :lg="16" :xl="18" class="tab-body-right">
      <div class="box">
        <div class="box-body">
          <RightDetailInfo :title="'单位医疗保险费已核销列表详情'" :options="columns.slice(2)" :list-data="currDetail">
...
export default {
  ...
  props: {
    ...
    detailHeight: { type: String, default: 'calc(100% - 140px)' }
  },
  data() {
    return {
      activeName: 'first',
