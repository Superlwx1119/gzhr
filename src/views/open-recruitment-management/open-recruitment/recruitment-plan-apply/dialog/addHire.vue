      ...
      <div class="box-body">
        ...
        <el-form ref="addForm" :model="addForm" label-width="105px" style="margin-bottom:10px">
          <el-row :gutter="12">
            ...
            <el-col :span="8">
              <el-form-item label="考试类别" prop="rc0909">
                <el-input v-model="addForm.rc0909" @input="handleSelectChange" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="专业工作经历" prop="rc0909">
                <el-input v-model="addForm.rc0909" @input="handleSelectChange" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
